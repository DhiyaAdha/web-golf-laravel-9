                                ...
                                <div class="form-wrap">
                                    <form action="{{ route('package.store') }}" method="POST">
                                        ...
                                        <div class="form-group @error('price_weekdays') has-error @enderror">
                                            <label class="control-label mb-10 text-left" for="examp">
                                                <label class="control-label mb-10 text-left" for="example-email">Harga Weekdays<span class="help"></span></label>
                                        ...
                                        <div class="form-group @error('price_weekend') has-error @enderror">
                                            <label class="control-label mb-10 text-left" for="examp">
                                                <label class="control-label mb-10 text-left" for="example-email">Harga Weekend<span class="help"></span></label>
                                                <div class="input-group">
                                                    <div class="input-group-addon">Rp</div>
