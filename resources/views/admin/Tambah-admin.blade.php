                    ...
                    <div class="panel-body">
                        ...
                        <form action="/store" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="password" class="form-control" id="show_hide_password" size="50px" placeholder="password" required autofocus>
                                </div>
                                <div class="form-group">
                                    <label class="control-label mb-10" for="">Nomer Hp</label>
                                    <input type="text" name="phone" class="form-control" id="result" size="50px" placeholder="Masukan Nomer Hp" required autofocus>
                                </div>
                                <div class="form-check">
                                    <label class="radio-inline">
