                            ...
                            <form action="{{ route('admin.edit', $users->id) }}" method="POST">
                                ...
                                <div class="hidden">
                                    <div class="form-group password-container">
                                        ...
                                        <input type="password" name="password" class="form-control @error('password') has-error @enderror" id="password" placeholder="Masukan Password Baru" value="{{ $users->password }}">
                                    ...
                                    <div class="form-group password-container">
                                        ...
                                        <input type="password" name="password" class="form-control @error('password') has-error @enderror"
                                            ...
                                            @error('password')
                                                <div class="text-danger"> {{ $message }}</div>
                                            @enderror
                                            <input style="vertical-align: -3px" class="checkbox-showPW" type="checkbox" onclick="myFunction()">&nbsp;
                                            <span style="color: #B2B2B2;">Lihat Password</span>
                                    </div>
                                    <div class="form-group password-container">
                                        <label class="pull-left control-label mb-10" for="password_confirmation">Konfirmasi Password</label>
                                        <div class="clearfix"></div>
                                        <input type="password" name="password_confirmation" class="form-control @error('password') is-invalid @enderror" id="password_confirmation2" placeholder="Masukan Password Baru" value="">
                                            ...
                                            @error('password_confirmation')
                                                <div class="text-danger"> {{ $message }}</div>
                                            @enderror
                                            <input style="vertical-align: -3px" class="checkbox-showPW" type="checkbox" onclick="myFunction2()">&nbsp;
                                            <span style="color: #B2B2B2;">Lihat Password</span>
                                    </div>
                                <div class="hidden">
                                    <div class="form-group @error('phone') has-error @enderror">
                                        ...
                                        <div class="radio-list">
                                            <div class="radio-inline pl-0">
                                                <span class="radio radio-info"> 
                                                    <input type="radio" name="role_id" id="radio_11" value="1" {{ $users->role_id == 1 ? 'checked' : '' }}>
                                                    <label for="radio_11">Admin</label>
                                                </span>
                                            </div>
                                            <div class="radio-inline pl-0">
                                                <span class="radio radio-info"> 
                                                    <input type="radio" name="role_id" id="radio_12" value="2" {{ $users->role_id == 2 ? 'checked' : '' }}>
                                                    <label for="radio_12">Super Admin</label>
                                                </span>
                                            </div>
                                        </div>
