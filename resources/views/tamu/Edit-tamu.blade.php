                                    ...
                                    <form   action="{{ route('daftar-tamu.update', $visitor->id) }}" method="POST">
                                        ...
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="name" value="{{ $visitor->name }}" class="form-control" id="name" size="50px" placeholder="Masukan Nama" required autofocus>
                                            </div>
                                            <div class="form-group">
                                                <label class="control-label mb-10" for="address">Alamat</label>
                                                <input type="text" class="form-control" name="address" value="{{ $visitor->address }}" id="address" size="50px" placeholder="Masukan Alamat" required autofocus>
                                            </div>
                                            <div class="form-group">
                                                <label class="control-label mb-10" for="gender">Jenis Kelamin</label>
                                                <div class="form-check">
                                                    <label class="radio-inline">
                                                        <input type="radio" name="gender" id="gender" value="laki-laki" <?php echo ($visitor->gender=='laki-laki')?'checked':'' ?>>Pria
                                                    </label>
                                                    <label class="radio-inline">
                                                        <input type="radio" name="gender" id="gender" value="perempuan" <?php echo ($visitor->gender=='perempuan')?'checked':'' ?>>Wanita
                                                    </label> 
                                                </div>
                                            </div>
                                        </div>
