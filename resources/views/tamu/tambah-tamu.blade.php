                        ...
                        <div class="panel-body">
                            ...
                            <div class="form-group @error('company') has-error @enderror">
                                ...
                                <input type="text" name="company" class="form-control" id="company" size="50px"
                                    value="{{ old('company') }}" placeholder="Masukan Nama Perusahaan">
                                @error('company')
                                    <div class="text-danger"> {{ $message }}</div>
                                @enderror
                            </div>
                            <div class="form-group @error('position') has-error @enderror">
                                ...
                                <input type="text" name="position" class="form-control" id="position" size="50px"
                                    value="{{ old('position') }}" placeholder="Masukan Jabatan">
                                @error('position')
                                    <div class="text-danger"> {{ $message }}</div>
                                @enderror
                            </div>
                                ...
                                <div class="radio-list">
                                    <div class="radio-inline pl-0">
                                        <span class="radio radio-info"> <input type="radio" name="category"
                                                id="category-m" value="pertamina"
                                                {{ old('category') == 'pertamina' ? 'checked=' . '"' . 'checked' . '"' : '' }}>
                                            <label for="category-m">PERTAMINA</label>
                                        </span>
                                    </div>
                                    <div class="radio-inline pl-0">
                                        <span class="radio radio-info"> <input type="radio" name="category"
                                                id="category-w" value="pensiunan">
                                            {{ old('category') == 'pensiunan' ? 'checked=' . '"' . 'checked' . '"' : '' }}
                                            <label for="category-w">PENSIUNAN</label>
                                        </span>
                                    </div>
                                </div>
                                @error('category')
