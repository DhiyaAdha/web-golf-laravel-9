                    ...
                    <div class="panel panel-default border-panel card-view">
                        ...
                        <div class="panel-heading"
                            ...
                            <form action="{{ route('tamureguler') }}" method="POST">
                                ...
                                <input type="hidden" value="REGULER" name="tipe_member">
                            ...
                            <div class="d-flex justify-content-between active-checkout">
                                ...
                                {{-- <a href="#"
                                    ...
                                    <i class="icon-rocket"></i>
                                    <span class="btn-text" class="mt-15 mb-15 btn-xs btn btn-primary btn-anim">Simpan Nama</span>
                                </a> --}}
                                <button type="submit" class="mt-15 mb-15 btn-xs btn btn-primary btn-anim">
                                    <i class="icon-rocket"></i>
                                    <span class="btn-text" class="mt-15 mb-15 btn-xs btn btn-primary btn-anim">Simpan Nama</span></button>
