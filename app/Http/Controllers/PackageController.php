        ...
        if ($request->ajax()) {
            return datatables()
                ...
                ->addColumn('action', function ($data) {
                    $button = 
                        '<a name="edit" data-toggle="tooltip" data-placement="top" title="" data-original-title="Tooltip on top" href="package/edit/'.$data->id.'"><svg width="21" height="21";viewBox="0 0 21 21" fill="none" xmlns="http://www.w3.org/2000/svg">
