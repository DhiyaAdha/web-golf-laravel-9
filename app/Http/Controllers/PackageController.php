...
use App\Exports\DaftarPaketExport;
...
class PackageController extends Controller
{
        ...
        if ($request->ajax()) {
            return datatables()
                ...
                ->addColumn('action', function ($data) {
                    $button =
                        '<a name="edit" data-toggle="tooltip" data-placement="top" title="Edit" href="'.url('package/edit/'.Crypt::encryptString($data->id)).'"><svg width="21" height="21";viewBox="0 0 21 21" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    public function store(Request $request)
    {
        ...
        if($request->price_weekdays == null){
            Package::create([
                ...
                'price_weekdays' => str_replace('.','',$request->price_discount),
                'price_weekend' => str_replace('.','',$request->price_discount),
    ...
    public function edit($id)
    {
        try {
            ...
            $package = Package::findOrFail($decrypt_id);
    ...
    public function update(Request $request, $id)
    {
        ...
        if($request->price_weekdays == null){
            ...
            $package->price_weekdays = str_replace('.','',$request->price_discount);
            $package->price_weekend = str_replace('.','',$request->price_discount);
    ...
    {
        $package = Package::find($req->get('id'));
    ...
    public function export_excel_package()
    {
        return Excel::download(new DaftarPaketExport, 'daftar-paket.xlsx');
    }
}
