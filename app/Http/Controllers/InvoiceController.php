...
class InvoiceController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        // ->groupBy('log_transactions.visitor_id');
        if($request->ajax()){
