...
class CardTamuController extends Controller
{
    /**
    ...
    {
        //
        $transaction = LogTransaction::select([
            'id',
            'status',
        ])
