...
class AdminController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('admin.daftar-admin', compact('visitor'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('admin.edit-admin', compact('visitor'));
    }
