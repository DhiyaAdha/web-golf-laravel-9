...
class TamuController extends Controller
{
    ...
    public function inserttamu(Request $request)
    {
        $this->validate(
            ...
            [
                ...
                'phone' => 'required|unique:visitors,phone|unique:users,phone|numeric|digits_between:10,12',
                'address' => 'required',
                'gender' => 'required',
            ...
            [
                ...
                'phone.digits_between' => 'Nomor Hp minimal 10 digit dan maksimal 12 digit',
    ...
    public function update(Request $request, $id, Loglimit $limit)
    {
        $this->validate(
            ...
            [
                ...
                'phone' => 'required|numeric|digits_between:10,12|unique:visitors,phone,' . $id,
                'address' => 'required',
                'gender' => 'required',
    ...
    {
        $visitor = Visitor::find($req->get('id'));
    ...
    {
        $filePath = public_path("kartutamu.pdf");
        $headers = ['Content-Type: application/pdf'];
        $fileName = time().'.pdf';

        return response()->download($filePath, $fileName, $headers);

        // return response()->download('kartutamu.pdf');
    }
}
