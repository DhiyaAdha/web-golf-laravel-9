...
Route::group(['middleware' => ['auth', 'ceklevel:1']], function () {
    ...
    Route::get('/scan-tamu', [ScanController::class, 'scantamu'])->name(
        'scan-tamu'
    );
    ...
    Route::get('/daftar-tamu', [TamuController::class, 'daftartamu'])->name(
        'daftar-tamu'
    );
    ...
    route::get('qrcode/{id}', [ScanController::class, 'generate'])->name(
        'generate'
    );
    route::get('/daftar-tamu/hapus/{id}', [
    ...
    Route::get('/dashboard', [AuthController::class, 'dashboard'])->middleware(
        'auth'
    );
    Route::get('/daftar-admin', [AuthController::class, 'daftar_admin'])->name(
        'daftar-admin'
...
Route::group(['middleware' => ['auth', 'ceklevel:1']], function () {
    ...
    Route::get('/edit-tamu', [TamuController::class, 'edittamu'])->name(
        'edit-tamu'
    );
});
...
Route::group(['middleware' => ['auth', 'ceklevel:1,2']], function () {
    ...
    Route::get('/kartu-tamu', [TamuController::class, 'kartutamu'])->name(
        'kartu-tamu'
    );
    ...
    Route::get('/riwayat-limit', [TamuController::class, 'riwayatlimit'])->name(
        'riwayat-limit'
    );
    Route::post('/inserttamu', [TamuController::class, 'inserttamu'])->name(
        'inserttamu'
    ...
    Route::get('/edit-tamu', [AuthController::class, 'edittamu'])->name(
        'edit-tamu'
    );
});
